...
function Input({ className, type, ...props }: React.ComponentProps<'input'>) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        'flex h-10 w-full min-w-0 rounded-4xl border border-input bg-card p-3 text-heading text-sm outline-none transition-all file:inline-flex file:font-medium file:text-foreground file:text-sm placeholder:text-muted-foreground disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50',
